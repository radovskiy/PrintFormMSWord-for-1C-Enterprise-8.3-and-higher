# Печатная форма "Договоры с клиентами" WORD для справочника "Договоры контрагентов" со штрихкодом документа. Для типовых конфигураций 1С Предприятие 8.3 УТ11, ERP2 и др. (управляемые формы, БСП)
